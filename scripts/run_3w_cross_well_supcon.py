...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/3w_cross_well_supcon.yaml")
    ...
    for seed in selected:
        ...
        current["training"]["supcon_batching"] = "cross_well_positive_safe"
        current["training"]["cross_well_sampler"] = copy.deepcopy(config["cross_well_sampler"])
        current["comparison_balanced_sampler"] = copy.deepcopy(config["comparison_balanced_sampler"])
